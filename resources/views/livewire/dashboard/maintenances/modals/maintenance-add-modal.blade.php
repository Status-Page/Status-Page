        ...
        <x-jet-dialog-modal wire:model="modal">
            ...
            <x-slot name="content">
                ...
                <div class="col-span-6 sm:col-span-4 mb-4">
                    ...
                    <textarea id="message" wire:model="incidentUpdate.text" class="h-96 mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md dark:bg-discordDark dark:border-discordBlack"></textarea>
