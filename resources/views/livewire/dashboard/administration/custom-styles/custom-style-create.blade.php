        ...
        <div class="flex justify-between">
            <div class="grid grid-cols-12 sm:grid-cols-4 w-full">
                <div class="col-span-6 sm:col-span-4 mb-4">
                    <x-jet-label for="enable_header" class="text-lg" value="{{ __('custom-styles.create.enable_header') }}" />
                ...
                <div class="col-span-12 sm:col-span-4 mb-4">
                    <x-jet-label for="header" class="text-lg" value="{{ __('custom-styles.create.header') }}" />
                ...
                <div class="col-span-6 sm:col-span-4 mb-4">
                    <x-jet-label for="enable_footer" class="text-lg" value="{{ __('custom-styles.create.enable_footer') }}" />
                ...
                <div class="col-span-12 sm:col-span-4 mb-4">
                    <x-jet-label for="footer" class="text-lg" value="{{ __('custom-styles.create.footer') }}" />
                ...
                <div class="col-span-12 sm:col-span-4 mb-4">
                    <x-jet-label for="custom_css" class="text-lg" value="{{ __('custom-styles.create.custom_css') }}" />
                ...
                <div class="col-span-12 sm:col-span-4 mb-4">
                    <x-jet-label for="active" class="text-lg" value="{{ __('custom-styles.create.active') }}" />
                ...
                <div class="mb-6">
                    <x-jet-button wire:click="saveCustomStyle">
                        {{ __('custom-styles.create.create') }}
                    </x-jet-button>
                </div>
            </div>
        </div>
