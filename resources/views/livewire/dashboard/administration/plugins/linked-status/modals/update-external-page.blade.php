<div>
    <button wire:loading.attr="disabled" wire:click="start" class="text-indigo-600 hover:text-indigo-900">
        {{ __('linked_status.modal_update.button') }}
    </button>

    <div class="text-left">
        <x-jet-dialog-modal wire:model="modal">
            <x-slot name="title">
                {{ __('linked_status.modal_update.title') }}
            </x-slot>

            <x-slot name="content">
                <div class="col-span-6 sm:col-span-4 mb-4">
                    <x-jet-label for="domain" class="text-lg" value="{{ __('linked_status.modal_update.domain') }}" />
                ...
                <div class="col-span-6 sm:col-span-4 mb-4">
                    <x-jet-label for="provider" class="text-lg" value="{{ __('linked_status.modal_update.provider') }}" />
                ...
                <div class="col-span-6 sm:col-span-4 mb-4">
                    <x-jet-label for="create_linked_incidents" class="text-lg" value="{{ __('linked_status.modal_update.c_linked_incidents') }}" />
                ...
                <div class="col-span-6 sm:col-span-4 mb-4">
                    <x-jet-label for="create_linked_maintenances" class="text-lg" value="{{ __('linked_status.modal_update.c_linked_maintenances') }}" />
            ...
            <x-slot name="footer">
                ...
                <x-jet-danger-button class="ml-2" wire:click="save" wire:loading.attr="disabled">
                    {{ __('linked_status.modal_update.submit') }}
                </x-jet-danger-button>
            </x-slot>
        </x-jet-dialog-modal>
    </div>
