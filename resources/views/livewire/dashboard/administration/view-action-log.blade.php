<div>
    <x-slot name="header">
        ...
        <p>Action Logs for the past {{ \App\Models\Setting::getInteger('actionlog_backlog') }} days. Older Logs are deleted daily.</p>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex-col space-y-4">
            <div class="flex justify-between">
                <div class="w-1/3 flex space-x-2">
                    <x-input-dark type="text" wire:model="search" placeholder="Search Actions..." class="w-full"></x-jet-input>
                </div>
