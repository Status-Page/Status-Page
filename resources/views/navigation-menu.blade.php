<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-discordDark dark:text-white dark:border-discordBlack">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @can('read_components')
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('dashboard.components') }}" :active="request()->routeIs('dashboard.components')">
                            {{ __('Components') }}
                        </x-jet-nav-link>
                    </div>
                @endcan
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white dark:text-white dark:bg-discordDark hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                        {{ Auth::user()->name }}
