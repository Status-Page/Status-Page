...
Route::get('/maintenances/{incident_id}/updates', function (Request $request, $incident_id) {
...
Route::get('/maintenances/{incident_id}/updates/{id}', function (Request $request, $incident_id, $id) {
    if(APIHelpers::hasPermission('read:incidents', $request)){
        $incident = Incident::findOrFail($incident_id);
...
Route::post('/maintenances/{id}/updates', function (Request $request, $id) {
...
Route::delete('/maintenances/{id}/updates/{update}', function (Request $request, $id, $update) {
